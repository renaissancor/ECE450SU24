...
const COLORS = [
  ...
  "#ff8042", "#ffbb28", "#ff7300", "#d0ed57", "#0088FE", "#00C49F"
];
...
const InstructorsOverview: React.FC = () => {
  ...
  const fetchData = () => {
    fetch(`http://127.0.0.1:5000/projects-by-instructor?startYear=${startYear}&startSemester=${startSemester}&endYear=${endYear}&endSemester=${endSemester}`)
      ...
      .catch(error => console.error('Error fetching project data by instructor:', error));
  };
