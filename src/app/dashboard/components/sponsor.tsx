...
const SponsorsOverview: React.FC = () => {
  ...
  const fetchData = () => {
    fetch(`http://127.0.0.1:5000/projects-by-sponsor?startYear=${startYear}&startSemester=${startSemester}&endYear=${endYear}&endSemester=${endSemester}`)
      ...
      .catch(error => console.error('Error fetching project data by sponsor:', error));
  };
