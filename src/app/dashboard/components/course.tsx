...
const CoursesOverview: React.FC = () => {
  ...
  const fetchData = () => {
    fetch(`http://127.0.0.1:5000/projects-by-course?startYear=${startYear}&startSemester=${startSemester}&endYear=${endYear}&endSemester=${endSemester}`)
      ...
      .catch(error => console.error('Error fetching project data by course:', error));
  };
